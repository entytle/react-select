...
Select.propTypes = {
	...
	isAlwaysOpen: _propTypes2.default.bool, // optional value to check if dropdown has to kept open always
	inputValue: _propTypes2.default.string // input search value
};
